...
{
    /// <inheritdoc />
    public partial class AddPersonPoints : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PredictedScoreA = table.Column<int>(type: "integer", nullable: false),
                    PredictedScoreB = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Predictions_People_PersonId",
                        column: x => x.PersonId,
